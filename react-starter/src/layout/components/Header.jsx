...
import { Usuario } from "../../core/user/components";
    ...
    <header className="z-40 flex items-center justify-between w-full h-16">
      ...
      <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
        <div className="relative flex items-center justify-end w-full p-1 space-x-4">
          ...
          <button className="relative flex items-center text-gray-500 dark:text-white text-md" onClick={toggleDetails}>
            <Usuario showDetails={showDetails} />
            <svg
              width={20}
              height={20}
